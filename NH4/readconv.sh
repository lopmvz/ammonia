...
for i in {222..410..10}
do
python2 ~/Workdir/NH3NH4/read.py  PE_NH4_4H2O_step${i}0_nd.out > PE_NH4_4H2O_step${i}0.txt
if [ -s "PE_NH4_4H2O_step${i}0.txt" ]
then
python2 ~/Workdir/NH3NH4/conv.py PE_NH4_4H2O_step${i}0.txt > PE_NH4_4H2O_step${i}0.dat
fi
