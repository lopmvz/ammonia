...
data7 = np.genfromtxt('6-311++Gss_6-311Gss/PE_NH3_4H2O_step5000_nd_new_NH3_4H2O_step5000.out.dat')
omega = data7[:,0] 
speCCSD7 = (data7[:,1])

data8 = np.genfromtxt('6-311++Gss_6-31Gss/PE_NH3_4H2O_step5000_nd_ecp_new_NH3_4H2O_step5000.out.txt')
...
plt.savefig('comp_nh3_step5000.pdf')
plt.show()
